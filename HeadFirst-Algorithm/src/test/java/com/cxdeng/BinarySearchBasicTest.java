...
import static com.cxdeng.BinarySearchBasic.binarySearchBasic;
import static org.junit.jupiter.api.Assertions.*;

class BinarySearchBasicTest {

    @Test
    @DisplayName("FOUND")
    void binarySearchBasicFoundTest() {
    ...
    void binarySearchBasicNotFoundTest() {
        int[] arr = {7, 13, 21, 30, 38, 44, 52, 53};
